...
<div id="content"><?php echo $content_top; ?>
  ...
  <div class="buttons">
    <div class="right"><a href="<?php echo $checkout; ?>" class="button"><?php echo $button_checkout; ?></a>	
	<?php if ($show_pp_express_button) { ?>
	-- OR --
		<a href="<?php echo $paypal_express_checkout; ?>" class="button">PayPal Express Checkout</a>
	<?php } ?>
	</div>
...
$('select[name=\'country_id\']').bind('change', function() {
	$.ajax({
		url: 'index.php?route=common/ajax/country&country_id=' + this.value,
		dataType: 'json',
		beforeSend: function() {
