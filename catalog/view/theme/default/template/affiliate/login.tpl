    ...
    <div class="right">
      <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form">
        ...
        <div class="content">
          ...
          <input type="text" name="email" value="<?php echo $email; ?>" data-rule-required="true" data-rule-rangelength="5,96" data-rule-email="true" />
          <br />
          <br />
          <b><?php echo $entry_password; ?></b><br />
          <input type="password" name="password" value="<?php echo $password; ?>" data-rule-required="true" data-rule-rangelength="4,20" />
          <br />
