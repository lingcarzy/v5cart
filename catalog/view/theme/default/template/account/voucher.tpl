  ...
  <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form">
    <table class="form">
      <tr>
        ...
        <td><input type="text" name="to_name" value="<?php echo $to_name; ?>" data-rule-required="true" data-rule-maxlength="64" />
      ...
      <tr>
        ...
        <td><input type="text" name="to_email" value="<?php echo $to_email; ?>" data-rule-required="true" data-rule-maxlength="96" data-rule-email="true" />
      ...
      <tr>
        ...
        <td><input type="text" name="from_name" value="<?php echo $from_name; ?>" data-rule-required="true" data-rule-maxlength="64" />
      ...
      <tr>
        ...
        <td><input type="text" name="from_email" value="<?php echo $from_email; ?>" data-rule-required="true" data-rule-maxlength="96" data-rule-email="true" />
      ...
      <tr>
        ...
        <td><?php foreach ($voucher_themes as $voucher_theme) { ?>
          ...
          <input type="radio" name="voucher_theme_id" value="<?php echo $voucher_theme['voucher_theme_id']; ?>" id="voucher-<?php echo $voucher_theme['voucher_theme_id']; ?>" checked="checked" data-rule-required="true" />
          <label for="voucher-<?php echo $voucher_theme['voucher_theme_id']; ?>"><?php echo $voucher_theme['name']; ?></label>
          <?php } else { ?>
          <input type="radio" name="voucher_theme_id" value="<?php echo $voucher_theme['voucher_theme_id']; ?>" id="voucher-<?php echo $voucher_theme['voucher_theme_id']; ?>" data-rule-required="true" />
          <label for="voucher-<?php echo $voucher_theme['voucher_theme_id']; ?>"><?php echo $voucher_theme['name']; ?></label>
          <?php } ?>
          <br />
          <?php } ?>
      ...
      <tr>
        ...
        <td><input type="text" name="amount" value="<?php echo $amount; ?>" size="5" data-rule-required="true" data-rule-number="true"/>
