...
<div id="content"><?php echo $content_top; ?>
  ...
  <table class="list">
    <thead>
      <tr>
		...
		<td class="right"><?php echo $column_shipped; ?></td>
  ...
  <?php } ?>
    <?php if ($shipping_histories) { ?>
		<table class="list">
			<thead>
				<tr>
					<td class="left" colspan="5"><?php echo $text_shipping_info; ?></td>
				</tr>
			</thead>
			<tbody>
				<?php foreach ($shipping_histories as $his) { ?>
				<tr>
					<td class="left"><?php echo date($_['date_format_short'], $his['ship_date']); ?></td>
					<td class="left">
						<?php foreach($his['products'] as $p) { ?>
							<p><small><?php echo $p['name']; ?></small><br>
							<?php echo $p['model']; ?> <small>Qty</small>: <span class="green"><?php echo $p['shipped_qty']; ?></span></p>
						<?php } ?>
					</td>
					<td class="left"><?php echo $his['ship_carrier']; ?></td>
					<td class="left">
					...
					<td class="left"><?php echo $his['remark']; ?></td>
				</tr>
				<?php } ?>
			</tbody>
		</table>
