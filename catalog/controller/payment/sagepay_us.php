...
class ControllerPaymentSagepayUS extends Controller {
	protected function index() {
		...
		$this->render('payment/sagepay_us.tpl');
	}
	...
	public function send() {
		...
		$data  = 'm_id=' . C('sagepay_us_merchant_id');
		$data .= '&m_key=' . C('sagepay_us_merchant_key');
		...
		if ($response[1] == 'A') {
			...
			$this->model_checkout_order->update($this->session->data['order_id'], C('sagepay_us_order_status_id'), $message, false);
