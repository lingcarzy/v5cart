...
class ControllerShippingRoyalMail extends Controller {
	...
	public function index() {
		...
		if (isset($this->request->post['royal_mail_1st_class_standard_rate'])) {
			...
			$this->data['royal_mail_1st_class_standard_rate'] = C('royal_mail_1st_class_standard_rate');
		} else {
		...
		if (isset($this->request->post['royal_mail_1st_class_standard_insurance'])) {
			...
			$this->data['royal_mail_1st_class_standard_insurance'] = C('royal_mail_1st_class_standard_insurance');
		} else {
		...
		if (isset($this->request->post['royal_mail_1st_class_standard_status'])) {
			...
			$this->data['royal_mail_1st_class_standard_status'] = C('royal_mail_1st_class_standard_status');
		}
		...
		if (isset($this->request->post['royal_mail_1st_class_recorded_rate'])) {
			...
			$this->data['royal_mail_1st_class_recorded_rate'] = C('royal_mail_1st_class_recorded_rate');
		} else {
		...
		if (isset($this->request->post['royal_mail_1st_class_recorded_insurance'])) {
			...
			$this->data['royal_mail_1st_class_recorded_insurance'] = C('royal_mail_1st_class_recorded_insurance');
		} else {
		...
		if (isset($this->request->post['royal_mail_1st_class_recorded_status'])) {
			...
			$this->data['royal_mail_1st_class_recorded_status'] = C('royal_mail_1st_class_recorded_status');
		}
		...
		if (isset($this->request->post['royal_mail_2nd_class_standard_rate'])) {
			...
			$this->data['royal_mail_2nd_class_standard_rate'] = C('royal_mail_2nd_class_standard_rate');
		} else {
		...
		if (isset($this->request->post['royal_mail_2nd_class_standard_status'])) {
			...
			$this->data['royal_mail_2nd_class_standard_status'] = C('royal_mail_2nd_class_standard_status');
		}
		...
		if (isset($this->request->post['royal_mail_2nd_class_recorded_rate'])) {
			...
			$this->data['royal_mail_2nd_class_recorded_rate'] = C('royal_mail_2nd_class_recorded_rate');
		} else {
		...
		if (isset($this->request->post['royal_mail_2nd_class_recorded_insurance'])) {
			...
			$this->data['royal_mail_2nd_class_recorded_insurance'] = C('royal_mail_2nd_class_recorded_insurance');
		} else {
		...
		if (isset($this->request->post['royal_mail_2nd_class_recorded_status'])) {
			...
			$this->data['royal_mail_2nd_class_recorded_status'] = C('royal_mail_2nd_class_recorded_status');
		}
		...
		if (isset($this->request->post['royal_mail_special_delivery_500_rate'])) {
			...
			$this->data['royal_mail_special_delivery_500_rate'] = C('royal_mail_special_delivery_500_rate');
		} else {
		...
		if (isset($this->request->post['royal_mail_special_delivery_500_insurance'])) {
			...
			$this->data['royal_mail_special_delivery_500_insurance'] = C('royal_mail_special_delivery_500_insurance');
		} else {
		...
		if (isset($this->request->post['royal_mail_special_delivery_500_status'])) {
			...
			$this->data['royal_mail_special_delivery_500_status'] = C('royal_mail_special_delivery_500_status');
		}
		...
		if (isset($this->request->post['royal_mail_special_delivery_1000_rate'])) {
			...
			$this->data['royal_mail_special_delivery_1000_rate'] = C('royal_mail_special_delivery_1000_rate');
		} else {
		...
		if (isset($this->request->post['royal_mail_special_delivery_1000_insurance'])) {
			...
			$this->data['royal_mail_special_delivery_1000_insurance'] = C('royal_mail_special_delivery_1000_insurance');
		} else {
		...
		if (isset($this->request->post['royal_mail_special_delivery_1000_status'])) {
			...
			$this->data['royal_mail_special_delivery_1000_status'] = C('royal_mail_special_delivery_1000_status');
		}
		...
		if (isset($this->request->post['royal_mail_special_delivery_2500_rate'])) {
			...
			$this->data['royal_mail_special_delivery_2500_rate'] = C('royal_mail_special_delivery_2500_rate');
		} else {
		...
		if (isset($this->request->post['royal_mail_special_delivery_2500_insurance'])) {
			...
			$this->data['royal_mail_special_delivery_2500_insurance'] = C('royal_mail_special_delivery_2500_insurance');
		} else {
		...
		if (isset($this->request->post['royal_mail_special_delivery_2500_status'])) {
			...
			$this->data['royal_mail_special_delivery_2500_status'] = C('royal_mail_special_delivery_2500_status');
		}
		...
		if (isset($this->request->post['royal_mail_standard_parcels_rate'])) {
			...
			$this->data['royal_mail_standard_parcels_rate'] = C('royal_mail_standard_parcels_rate');
		} else {
		...
		if (isset($this->request->post['royal_mail_standard_parcels_insurance'])) {
			...
			$this->data['royal_mail_standard_parcels_insurance'] = C('royal_mail_standard_parcels_insurance');
		} else {
		...
		if (isset($this->request->post['royal_mail_standard_parcels_status'])) {
			...
			$this->data['royal_mail_standard_parcels_status'] = C('royal_mail_standard_parcels_status');
		}
		...
		if (isset($this->request->post['royal_mail_airmail_rate_1'])) {
			...
			$this->data['royal_mail_airmail_rate_1'] = C('royal_mail_airmail_rate_1');
		} else {
		...
		if (isset($this->request->post['royal_mail_airmail_rate_2'])) {
			...
			$this->data['royal_mail_airmail_rate_2'] = C('royal_mail_airmail_rate_2');
		} else {
		...
		if (isset($this->request->post['royal_mail_airmail_status'])) {
			...
			$this->data['royal_mail_airmail_status'] = C('royal_mail_airmail_status');
		}
		...
		if (isset($this->request->post['royal_mail_international_signed_rate_1'])) {
			...
			$this->data['royal_mail_international_signed_rate_1'] = C('royal_mail_international_signed_rate_1');
		} else {
		...
		if (isset($this->request->post['royal_mail_international_signed_insurance_1'])) {
			...
			$this->data['royal_mail_international_signed_insurance_1'] = C('royal_mail_international_signed_insurance_1');
		} else {
		...
		if (isset($this->request->post['royal_mail_international_signed_rate_2'])) {
			...
			$this->data['royal_mail_international_signed_rate_2'] = C('royal_mail_international_signed_rate_2');
		} else {
		...
		if (isset($this->request->post['royal_mail_international_signed_insurance_2'])) {
			...
			$this->data['royal_mail_international_signed_insurance_2'] = C('royal_mail_international_signed_insurance_2');
		} else {
		...
		if (isset($this->request->post['royal_mail_international_signed_status'])) {
			...
			$this->data['royal_mail_international_signed_status'] = C('royal_mail_international_signed_status');
		}
		...
		if (isset($this->request->post['royal_mail_airsure_rate_1'])) {
			...
			$this->data['royal_mail_airsure_rate_1'] = C('royal_mail_airsure_rate_1');
		} else {
		...
		if (isset($this->request->post['royal_mail_airsure_insurance_1'])) {
			...
			$this->data['royal_mail_airsure_insurance_1'] = C('royal_mail_airsure_insurance_1');
		} else {
		...
		if (isset($this->request->post['royal_mail_airsure_rate_2'])) {
			...
			$this->data['royal_mail_airsure_rate_2'] = C('royal_mail_airsure_rate_2');
		} else {
		...
		if (isset($this->request->post['royal_mail_airsure_insurance_2'])) {
			...
			$this->data['royal_mail_airsure_insurance_2'] = C('royal_mail_airsure_insurance_2');
		} else {
		...
		if (isset($this->request->post['royal_mail_airsure_status'])) {
			...
			$this->data['royal_mail_airsure_status'] = C('royal_mail_airsure_status');
		}
		...
		if (isset($this->request->post['royal_mail_surface_rate'])) {
			...
			$this->data['royal_mail_surface_rate'] = C('royal_mail_surface_rate');
		} else {
		...
		if (isset($this->request->post['royal_mail_surface_status'])) {
			...
			$this->data['royal_mail_surface_status'] = C('royal_mail_surface_status');
		}
		...
		if (isset($this->request->post['royal_mail_display_weight'])) {
			...
			$this->data['royal_mail_display_weight'] = C('royal_mail_display_weight');
		}
		...
		if (isset($this->request->post['royal_mail_display_insurance'])) {
			...
			$this->data['royal_mail_display_insurance'] = C('royal_mail_display_insurance');
		}
		...
		if (isset($this->request->post['royal_mail_weight_class_id'])) {
			...
			$this->data['royal_mail_weight_class_id'] = C('royal_mail_weight_class_id');
		}
		...
		if (isset($this->request->post['royal_mail_tax_class_id'])) {
			...
			$this->data['royal_mail_tax_class_id'] = C('royal_mail_tax_class_id');
		}
		...
		$this->display('shipping/royal_mail.tpl');
	}
