...
$_['entry_export']     = 'Export to spreadsheet file:';
$_['entry_description'] = '<p>Use this function to export or import your categories and products to or from a XLS spreadsheet file. <b>Always backup database before importing!</b></p><p><b>Import functions:</b><ul><li>Import new product</li><li>Update product data</li></ul></p>';
