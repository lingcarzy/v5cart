...
$_['range_length']  = "The %s field must be greater than %s and less than %s characters in length.";
...
$_['range']              = "The %s field must contain a number greater than %s and less then %s.";
$_['dateISO']            = "The %s field must be a valid date (ISO).";
$_['date']               = "The %s field must be a valid date.";