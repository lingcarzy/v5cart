...
<div id="content">
  ...
  <div class="box">
    <div class="heading">
      ...
      <div class="buttons"><a onclick="$('#form').submit();" class="button"><?php echo $_['button_save']; ?></a><a href="<?php echo $cancel; ?>" class="button"><?php echo $_['button_cancel']; ?></a></div>
    </div>
    <div class="content">
      ...
      <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form">
        <div id="tab-general"><a href="https://merchants.klarna.com/signup?locale=en&partner_id=d5c87110cebc383a826364769047042e777da5e8&utm_campaign=Platform&utm_medium=Partners&utm_source=Opencart" target="_blank" style="float: right;"><img src="view/image/payment/klarna_banner.gif" /></a>
          ...
          <div id="tab-<?php echo $country['code']; ?>" class="vtabs-content">
            <table class="form">
              <tr>
                <td><?php echo $_['entry_merchant']; ?></td>
              ...
              <tr>
                ...
                <td><select name="klarna_account[<?php echo $country['code']; ?>][server]">
                    ...
                    <option value="beta" selected="selected"><?php echo $_['text_beta']; ?></option>
                    <?php } else { ?>
                    <option value="beta"><?php echo $_['text_beta']; ?></option>
                    <?php } ?>
                  </select></td>
              </tr>
              <tr>
              ...
              <tr>
                <td><?php echo $_['entry_accepted_status']; ?></td>
