...
<div id="content">
  ...
  <div class="box">
    ...
    <div class="content">
      <form action="<?php echo UA('payment/sagepay'); ?>" method="post" enctype="multipart/form-data" id="form">
        <table class="form">
          <tr>
          ...
          <tr>
            ...
            <td><select name="sagepay_order_status_id">
				<?php echo form_select_option($order_statuses, $sagepay_order_status_id, null, 'order_status_id', 'name');?>
              </select></td>
          </tr>
          <tr>
            ...
            <td><select name="sagepay_geo_zone_id">
				...
				<?php echo form_select_option($geo_zones, $sagepay_geo_zone_id, null, 'geo_zone_id', 'name');?>
              </select></td>
          </tr>
          <tr>
            <td><?php echo $_['entry_status']; ?></td>
            <td><select name="sagepay_status">
				<?php echo form_select_option($_['option_statuses'], $sagepay_status, true);?>
              </select></td>
          </tr>
          <tr>
