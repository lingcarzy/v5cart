...
<div id="content">
  ...
  <div class="box">    
    ...
    <div class="content">
      <form action="<?php echo UA('payment/free_checkout'); ?>" method="post" enctype="multipart/form-data" id="form">
        <div id="tab-general" class="page">
          <table class="form">
            <tr>
              <td><?php echo $_['entry_order_status']; ?></td>
              <td><select name="free_checkout_order_status_id">
			  <?php echo form_select_option($order_statuses, $free_checkout_order_status_id, null, 'order_status_id', 'name');?>
                </select></td>
            </tr>
            <tr>
              <td><?php echo $_['entry_status']; ?></td>
              <td><select name="free_checkout_status">
			  <?php echo form_select_option($_['option_statuses'], $free_checkout_status, true);?>
                </select></td>
            </tr>
            <tr>
