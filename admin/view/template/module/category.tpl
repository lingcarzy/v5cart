...
<div id="content">
  ...
  <div class="box">
    ...
    <div class="content">
      <form action="<?php echo UA('module/category'); ?>" method="post" enctype="multipart/form-data" id="form">
        <table id="module" class="list">
          <thead>
            <tr>
              <td class="left"><?php echo $_['entry_layout']; ?></td>
              <td class="left"><?php echo $_['entry_position']; ?></td>
              <td class="left"><?php echo $_['entry_count']; ?></td>
          ...
          <tbody id="module-row<?php echo $module_row; ?>">
            <tr>
              ...
              <td class="left"><select name="category_module[<?php echo $module_row; ?>][count]">
				<?php echo form_select_option($_['option_statuses'], $module['count'], true);?>
                </select></td>
              <td class="left"><select name="category_module[<?php echo $module_row; ?>][status]">
				...
				<td class="left"><select name="category_module[<?php echo $module_row; ?>][cache]">
					<?php echo form_select_option($_['option_statuses'], $module['cache'], true);?>
                </select>&nbsp;<input type="text" name="category_module[<?php echo $module_row; ?>][expire]" value="<?php echo isset($module['expire']) ? $module['expire'] : 3600; ?>" size="3" /> /s</td>
...
function addModule() {	
    ...
    html += '      <option value="0"><?php echo $_['text_disabled']; ?></option>';
    html += '    </select></td>';
	html += '    <td class="left"><select name="category_module[' + module_row + '][cache]">';
    html += '      <option value="1" selected="selected"><?php echo $_['text_enabled']; ?></option>';
    html += '      <option value="0"><?php echo $_['text_disabled']; ?></option>';
    html += '    </select> <input type="text" name="category_module['+ module_row +'][expire]" value="3600" size="3" /> /s</td>';
