...
<div id="content">
  ...
  <div class="box">
    <div class="heading">
	  ...
	  <a href="<?php echo UA('extension/module'); ?>" class="button"><?php echo $_['button_cancel']; ?></a>
	  </div>
    </div>
    <div class="content">
      <form action="<?php echo UA('module/affiliate'); ?>" method="post" enctype="multipart/form-data" id="form">
          ...
          <tbody id="module-row<?php echo $module_row; ?>">
            <tr>
			  ...
			  <?php echo form_select_option($_['option_statuses'], $module['status'], true);?>
				...
				<td class="left"><select name="affiliate_module[<?php echo $module_row; ?>][cache]">
				<?php echo form_select_option($_['option_statuses'], $module['cache'], true);?>
                </select>&nbsp;<input type="text" name="affiliate_module[<?php echo $module_row; ?>][expire]" value="<?php echo isset($module['expire']) ? $module['expire'] : 3600; ?>" size="3" /> /s</td>
...
function addModule() {	
    ...
    html += '    </select></td>';
	html += '    <td class="left"><select name="affiliate_module[' + module_row + '][cache]">';
    html += '      <option value="1" selected="selected"><?php echo $_['text_enabled']; ?></option>';
    html += '      <option value="0"><?php echo $_['text_disabled']; ?></option>';
    html += '    </select> <input type="text" name="affiliate_module['+ module_row +'][expire]" value="3600" size="3" /> /s</td>';
