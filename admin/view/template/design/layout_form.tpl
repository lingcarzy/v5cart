...
<div id="content">
  ...
  <div class="box">
    <div class="heading">
      ...
      <div class="buttons"><a onclick="$('#form').submit();" class="button"><?php echo $_['button_save']; ?></a><a href="<?php echo UA('design/layout'); ?>" class="button"><?php echo $_['button_cancel']; ?></a></div>
    </div>
    <div class="content">
        ...
        <table id="route" class="list">
          <thead>
            <tr>
              ...
              <td class="left"><?php echo $_['entry_route']; ?></td>
              <td></td>
            </tr>
          </thead>
          <?php $route_row = 0; ?>
          ...
          <tbody id="route-row<?php echo $route_row; ?>">
            <tr>
              <td class="left"><select name="layout_route[<?php echo $route_row; ?>][store_id]">
				  ...
				  <?php echo form_select_option($stores, $layout_route['store_id'], null, 'store_id', 'name'); ?>
                </select></td>
              <td class="left"><input type="text" name="layout_route[<?php echo $route_row; ?>][route]" value="<?php echo $layout_route['route']; ?>" /></td>
              <td class="left"><a onclick="$('#route-row<?php echo $route_row; ?>').remove();" class="button"><?php echo $_['button_remove']; ?></a></td>
            </tr>
          </tbody>
          <?php $route_row++; ?>
          <?php } ?>
          <tfoot>
            <tr>
              <td colspan="2"></td>
              <td class="left"><a onclick="addRoute();" class="button"><?php echo $_['button_add_route']; ?></a></td>
            </tr>
          </tfoot>
        </table>
      </form>
...
function addRoute() {
	...
	html += '    <option value="0"><?php echo $_['text_default']; ?></option>';
	...
	html += '    <td class="left"><a onclick="$(\'#route-row' + route_row + '\').remove();" class="button"><?php echo $_['button_remove']; ?></a></td>';
	html += '  </tr>';
	html += '</tbody>';
