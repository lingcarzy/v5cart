...
<div id="content">
  ...
  <div class="box">
    <div class="heading">
      ...
      <div class="buttons">
	  <a href="<?php echo UA('sale/voucher/insert'); ?>" class="button"><?php echo $_['button_insert']; ?></a>
	  <a onclick="document.getElementById('form').submit();" class="button"><?php echo $_['button_delete']; ?></a></div>
    </div>
    <div class="content">
      <form action="<?php echo UA('sale/voucher/delete'); ?>" method="post" enctype="multipart/form-data" id="form">
        <table class="list">
          <thead>
            <tr>
              ...
              <td class="left"><?php if ($sort == 'v.from_name') { ?>
                <a href="<?php echo $sort_from; ?>" class="<?php echo $order; ?>"><?php echo $_['column_from']; ?></a>
                <?php } else { ?>
                <a href="<?php echo $sort_from; ?>"><?php echo $_['column_from']; ?></a>
                <?php } ?></td>
              <td class="left"><?php if ($sort == 'v.to_name') { ?>
                <a href="<?php echo $sort_to; ?>" class="<?php echo $order; ?>"><?php echo $_['column_to']; ?></a>
                <?php } else { ?>
                <a href="<?php echo $sort_to; ?>"><?php echo $_['column_to']; ?></a>
                <?php } ?></td>
              <td class="right"><?php if ($sort == 'v.amount') { ?>
                <a href="<?php echo $sort_amount; ?>" class="<?php echo $order; ?>"><?php echo $_['column_amount']; ?></a>
                <?php } else { ?>
                <a href="<?php echo $sort_amount; ?>"><?php echo $_['column_amount']; ?></a>
                <?php } ?></td>
              <td class="left"><?php if ($sort == 'theme') { ?>
                <a href="<?php echo $sort_theme; ?>" class="<?php echo $order; ?>"><?php echo $_['column_theme']; ?></a>
                <?php } else { ?>
                <a href="<?php echo $sort_theme; ?>"><?php echo $_['column_theme']; ?></a>
                <?php } ?></td>
          ...
          <tbody>
            ...
            <tr>
              ...
              <td class="right">[ <a onclick="sendVoucher('<?php echo $voucher['voucher_id']; ?>');"><?php echo $_['text_send']; ?></a> ]
...
function sendVoucher(voucher_id) {
	$.ajax({
		url: '<?php echo UA('sale/voucher/send'); ?>&voucher_id=' + voucher_id,
		type: 'post',
		dataType: 'json',
		beforeSend: function() {
