...
<div id="content">
  ...
  <div class="box">
    <div class="heading">
	  ...
	  <a href="<?php echo UA('sale/voucher_theme'); ?>" class="button"><?php echo $_['button_cancel']; ?></a></div>
    </div>
    <div class="content">
        ...
        <table class="form">
          ...
          <tr>
            ...
            <td valign="top"><div class="image"><img src="<?php echo $thumb; ?>" alt="" id="thumb" />
                ...
                <br /><a onclick="image_upload('image', 'thumb', '<?php echo $token;?>');"><?php echo $_['text_browse']; ?></a>&nbsp;&nbsp;|&nbsp;&nbsp;<a onclick="$('#thumb').attr('src', '<?php echo $no_image; ?>'); $('#image').attr('value', '');"><?php echo $_['text_clear']; ?></a></div>
