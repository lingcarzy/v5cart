...
<div id="content">
  ...
  <div class="box">
    <div class="heading">
      <h1><img src="view/image/mail.png" alt="" /> <?php echo $_['heading_title']; ?></h1>
      <div class="buttons"><a id="button-send" onclick="send('<?php echo UA('sale/contact/send'); ?>');" class="button"><?php echo $_['button_send']; ?></a>
    ...
    <div class="content">
        <table id="mail" class="form">
          ...
          <tr>
            <td><?php echo $_['entry_to']; ?></td>
            <td><select name="to">
                <option value="newsletter"><?php echo $_['text_newsletter']; ?></option>
                <option value="customer_all"><?php echo $_['text_customer_all']; ?></option>
                <option value="customer_group"><?php echo $_['text_customer_group']; ?></option>
                <option value="customer"><?php echo $_['text_customer']; ?></option>
                <option value="affiliate_all"><?php echo $_['text_affiliate_all']; ?></option>
                <option value="affiliate"><?php echo $_['text_affiliate']; ?></option>
                <option value="product"><?php echo $_['text_product']; ?></option>
              </select></td>
          </tr>
          ...
          <tr>
            <td><span class="required">*</span> <?php echo $_['entry_subject']; ?></td>
