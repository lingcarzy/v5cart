...
<div id="content">
  ...
  <div class="box">
    ...
    <div class="content">
      <div id="vtabs" class="vtabs"><a href="#tab-customer"><?php echo $_['tab_customer']; ?></a><a href="#tab-payment"><?php echo $_['tab_payment']; ?></a><a href="#tab-shipping"><?php echo $_['tab_shipping']; ?></a><a href="#tab-product"><?php echo $_['tab_product']; ?></a><a href="#tab-voucher"><?php echo $_['tab_voucher']; ?></a><a href="#tab-total"><?php echo $_['tab_total']; ?></a></div>
      <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form">
          ...
          <table class="form">
            <tr>
              ...
              <td class="left"><select name="store_id">
				  ...
				  <?php echo form_select_option($stores, $store_id, null, 'store_id', 'name'); ?>
                </select></td>
            </tr>
            <tr>
            ...
            <tr>
			  ...
			  <?php echo form_select_option($customer_groups, $customer_group_id, null, 'customer_group_id', 'name'); ?>
                </select></td>
            </tr>
            <tr>
            ...
            <tr>
			  ...
			  <tr>
				  ...
				  <td><input type="text" name="remark" value="<?php echo $remark; ?>" size="80"/></td>
			  </tr>
          </table>
        </div>
        <div id="tab-payment" class="vtabs-content">
          <table class="form">
            <tr>
              <td><?php echo $_['entry_address']; ?></td>
            ...
            <tr>
              ...
              <td><input type="text" name="payment_firstname" value="<?php echo $payment_firstname; ?>" />
                <?php echo form_error('payment_firstname') ?></td>
            </tr>
            <tr>
              <td><span class="required">*</span> <?php echo $_['entry_lastname']; ?></td>
              <td><input type="text" name="payment_lastname" value="<?php echo $payment_lastname; ?>" />
                <?php echo form_error('payment_lastname') ?></td>
            </tr>
            <tr>
            ...
            <tr id="company-id-display">
              <td><span id="company-id-required" class="required">*</span> <?php echo $_['entry_company_id']; ?></td>
              <td><input type="text" name="payment_company_id" value="<?php echo $payment_company_id; ?>" /></td>
            </tr>
            <tr id="tax-id-display">
              <td><span id="tax-id-required" class="required">*</span> <?php echo $_['entry_tax_id']; ?></td>
              <td><input type="text" name="payment_tax_id" value="<?php echo $payment_tax_id; ?>" />
                <?php if (isset($error_payment_tax_id)) { ?>
            ...
            <tr>
              ...
              <td><input type="text" name="payment_address_1" value="<?php echo $payment_address_1; ?>" />
                <?php echo form_error('payment_address_1') ?></td>
            </tr>
            <tr>
            ...
            <tr>
              ...
              <td><input type="text" name="payment_city" value="<?php echo $payment_city; ?>" />
                <?php echo form_error('payment_city') ?></td>
            </tr>
            <tr>
              <td><span id="payment-postcode-required" class="required">*</span> <?php echo $_['entry_postcode']; ?></td>
              <td><input type="text" name="payment_postcode" value="<?php echo $payment_postcode; ?>" />
                <?php echo form_error('payment_postcode') ?></td>
            </tr>
            <tr>
              ...
              <td><select name="payment_country_id">
				  ...
				  <?php echo form_select_option($countries, $payment_country_id, true);?>
                </select>
                <?php echo form_error('payment_country_id') ?></td>
            </tr>
            <tr>
              <td><span class="required">*</span> <?php echo $_['entry_zone']; ?></td>
              <td><select name="payment_zone_id">
                </select>
                <?php echo form_error('payment_zone_id') ?></td>
            </tr>
          </table>
        </div>
          ...
          <table class="form">
            ...
            <tr>
              ...
              <td><input type="text" name="shipping_firstname" value="<?php echo $shipping_firstname; ?>" />
               <?php echo form_error('shipping_firstname') ?></td>
            </tr>
            <tr>
              <td><span class="required">*</span> <?php echo $_['entry_lastname']; ?></td>
              <td><input type="text" name="shipping_lastname" value="<?php echo $shipping_lastname; ?>" />
                <?php echo form_error('shipping_lastname') ?></td>
            </tr>
            <tr>
              <td><?php echo $_['entry_company']; ?></td>
            ...
            <tr>
              ...
              <td><input type="text" name="shipping_address_1" value="<?php echo $shipping_address_1; ?>" />
               <?php echo form_error('shipping_address_1') ?></td>
            </tr>
            <tr>
              <td><?php echo $_['entry_address_2']; ?></td>
            ...
            <tr>
              <td><span id="shipping-postcode-required" class="required">*</span> <?php echo $_['entry_postcode']; ?></td>
              <td><input type="text" name="shipping_postcode" value="<?php echo $shipping_postcode; ?>" />
               <?php echo form_error('shipping_postcode') ?></td>
            </tr>
            <tr>
              <td><span class="required">*</span> <?php echo $_['entry_country']; ?></td>
              <td><select name="shipping_country_id">
                  <option value=""><?php echo $_['text_select']; ?></option>
				  <?php echo form_select_option($countries, $shipping_country_id, true);?>
                </select>
               <?php echo form_error('shipping_country_id') ?></td>
            </tr>
            <tr>
              <td><span class="required">*</span> <?php echo $_['entry_zone']; ?></td>
              <td><select name="shipping_zone_id">
                </select>
               <?php echo form_error('shipping_zone_id') ?></td>
            </tr>
          </table>
        </div>
        <div id="tab-product" class="vtabs-content">
          <table class="list">
            ...
            <tbody id="product">
              ...
              <tr id="product-row<?php echo $product_row; ?>">
                <td class="center" style="width: 3px;"><img src="view/image/delete.png" title="<?php echo $_['button_remove']; ?>" alt="<?php echo $_['button_remove']; ?>" style="cursor: pointer;" onclick="$('#product-row<?php echo $product_row; ?>').remove(); $('#button-update').trigger('click');" /></td>
          ...
          <table class="list">
            <thead>
              <tr>
                <td colspan="2" class="left"><?php echo $_['text_product']; ?></td>
              </tr>
            </thead>
            <tbody>
              <tr>
                <td class="left"><?php echo $_['entry_product']; ?></td>
                <td class="left"><input type="text" name="product" value="" />
                  <input type="hidden" name="product_id" value="" /></td>
              </tr>
              <tr id="option"></tr>
              <tr>
                <td class="left"><?php echo $_['entry_quantity']; ?></td>
            ...
            <tfoot>
              <tr>
                <td class="left">&nbsp;</td>
                <td class="left"><a id="button-product" class="button"><?php echo $_['button_add_product']; ?></a></td>
              </tr>
            </tfoot>
          </table>
        </div>
        <div id="tab-voucher" class="vtabs-content">
          <table class="list">
            ...
            <tbody id="voucher">
              ...
              <tr id="voucher-row<?php echo $voucher_row; ?>">
                <td class="center" style="width: 3px;"><img src="view/image/delete.png" title="<?php echo $_['button_remove']; ?>" alt="<?php echo $_['button_remove']; ?>" style="cursor: pointer;" onclick="$('#voucher-row<?php echo $voucher_row; ?>').remove(); $('#button-update').trigger('click');" /></td>
          ...
          <table class="list">
            <thead>
              <tr>
                <td colspan="2" class="left"><?php echo $_['text_voucher']; ?></td>
              </tr>
            </thead>
            <tbody>
              <tr>
                <td class="left"><span class="required">*</span> <?php echo $_['entry_to_name']; ?></td>
                <td class="left"><input type="text" name="to_name" value="" /></td>
              </tr>
              <tr>
                <td class="left"><span class="required">*</span> <?php echo $_['entry_to_email']; ?></td>
                <td class="left"><input type="text" name="to_email" value="" /></td>
              </tr>
              <tr>
                <td class="left"><span class="required">*</span> <?php echo $_['entry_from_name']; ?></td>
                <td class="left"><input type="text" name="from_name" value="" /></td>
              </tr>
              <tr>
                <td class="left"><span class="required">*</span> <?php echo $_['entry_from_email']; ?></td>
                <td class="left"><input type="text" name="from_email" value="" /></td>
              </tr>
              <tr>
                <td class="left"><span class="required">*</span> <?php echo $_['entry_theme']; ?></td>
              ...
              <tr>
                <td class="left"><?php echo $_['entry_message']; ?></td>
                <td class="left"><textarea name="message" cols="40" rows="5"></textarea></td>
              </tr>
              <tr>
                <td class="left"><span class="required">*</span> <?php echo $_['entry_amount']; ?></td>
            ...
            <tfoot>
              <tr>
                <td class="left">&nbsp;</td>
                <td class="left"><a id="button-voucher" class="button"><?php echo $_['button_add_voucher']; ?></a></td>
              </tr>
            </tfoot>
          </table>
        </div>
        <div id="tab-total" class="vtabs-content">
          ...
          <table class="list">
            <thead>
              <tr>
                <td class="left" colspan="2"><?php echo $_['text_order']; ?></td>
              </tr>
            </thead>
            <tbody>
              <tr>
                <td class="left"><?php echo $_['entry_shipping']; ?></td>
                <td class="left"><select name="shipping">
                  ...
                  <?php echo form_error('shipping_method') ?></td>
              </tr>
              <tr>
                <td class="left"><?php echo $_['entry_payment']; ?></td>
            ...
            <tfoot>
              <tr>
                <td class="left">&nbsp;</td>
                <td class="left"><a id="button-update" class="button"><?php echo $_['button_update_total']; ?></a></td>
              </tr>
            </tfoot>
          </table>
        </div>
...
$('select[name=\'payment_address\']').bind('change', function() {
	$.ajax({
		url: '<?php echo UA('sale/customer/address'); ?>&address_id=' + this.value,
		dataType: 'json',
		success: function(json) {
			if (json != '') {	
		...
		if (ui.item['option'] != '') {
			...
			for (i = 0; i < ui.item['option'].length; i++) {
				...
				if (option['type'] == 'file') {
					...
					html += option['name'] + '<br />';
					html += '<a id="button-option-' + option['product_option_id'] + '" class="button"><?php echo $_['button_upload']; ?></a>';
			...
			$('#option').html('<td class="left"><?php echo $_['entry_option']; ?></td><td class="left">' + html + '</td>');
			...
			for (i = 0; i < ui.item.option.length; i++) {
				...
				if (option['type'] == 'file') {		
					new AjaxUpload('#button-option-' + option['product_option_id'], {
						action: '<?php echo UA('sale/order/upload'); ?>',
						name: 'file',
						autoSubmit: true,
						responseType: 'json',
						data: option,
...
$('#button-product, #button-voucher, #button-update').live('click', function() {	
	...
	$.ajax({
		url: '<?php echo U('checkout/manual'); ?>',
		type: 'post',
		data: $(data),
		dataType: 'json',	
		beforeSend: function() {
		...
		success: function(json) {
			...
			if (json['order_product'] != '') {
				...
				for (i = 0; i < json['order_product'].length; i++) {
					...
					html += '  <td class="center" style="width: 3px;"><img src="view/image/delete.png" title="<?php echo $_['button_remove']; ?>" alt="<?php echo $_['button_remove']; ?>" style="cursor: pointer;" onclick="$(\'#product-row' + product_row + '\').remove(); $(\'#button-update\').trigger(\'click\');" /></td>';
				...
				html  = '</tr>';
				html += '  <td colspan="6" class="center"><?php echo $_['text_no_results']; ?></td>';
				html += '</tr>';	
			...
			if (json['order_voucher'] != '') {
				var voucher_row = 0;
				 ...
				 for (i in json['order_voucher']) {
					...
					html += '  <td class="center" style="width: 3px;"><img src="view/image/delete.png" title="<?php echo $_['button_remove']; ?>" alt="<?php echo $_['button_remove']; ?>" style="cursor: pointer;" onclick="$(\'#voucher-row' + voucher_row + '\').remove(); $(\'#button-update\').trigger(\'click\');" /></td>';
