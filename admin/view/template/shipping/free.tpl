...
<div id="content">
  ...
  <div class="box">
    ...
    <div class="content">
      <form action="<?php echo UA('shipping/free'); ?>" method="post" enctype="multipart/form-data" id="form">
        <table class="form">
          <tr>
          ...
          <tr>
            ...
            <td><select name="free_geo_zone_id">
				...
				<?php echo form_select_option($geo_zones, $free_geo_zone_id, null, 'geo_zone_id', 'name'); ?>
              </select></td>
          </tr>
          <tr>
            <td><?php echo $_['entry_status']; ?></td>
            <td><select name="free_status">
				<?php echo form_select_option($_['option_statuses'], $free_status, true); ?>
              </select></td>
          </tr>
          <tr>
