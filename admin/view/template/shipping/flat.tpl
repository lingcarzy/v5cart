...
<div id="content">
  ...
  <div class="box">
    ...
    <div class="content">
      <form action="<?php echo UA('shipping/flat'); ?>" method="post" enctype="multipart/form-data" id="form">
        <table class="form">
          <tr>
          ...
          <tr>
            ...
            <td><select name="flat_tax_class_id">
				  ...
				  <?php echo form_select_option($tax_classes, $flat_tax_class_id, null, 'tax_class_id', 'title'); ?>
                </select></td>
          </tr>
          <tr>
            ...
            <td><select name="flat_geo_zone_id">
				...
				<?php echo form_select_option($geo_zones, $flat_geo_zone_id, null, 'geo_zone_id', 'name'); ?>
              </select></td>
          </tr>
          <tr>
            <td><?php echo $_['entry_status']; ?></td>
            <td><select name="flat_status">
				<?php echo form_select_option($_['option_statuses'], $flat_status, true); ?>
              </select></td>
          </tr>
          <tr>
