...
<div id="content">
  ...
  <div class="box">
    <div class="heading">
      <h1><img src="view/image/home.png" alt="" /> <?php echo $_['heading_title']; ?></h1>
    </div>
    <div class="content">
      <div class="overview">
        <div class="dashboard-heading"><?php echo $_['text_overview']; ?></div>
        <div class="dashboard-content">
          <table>
            <tr>
              <td><?php echo $_['text_total_sale']; ?></td>
              <td><?php echo $total_sale; ?></td>
            </tr>
            <tr>
              <td><?php echo $_['text_total_sale_year']; ?></td>
              <td><?php echo $total_sale_year; ?></td>
            </tr>
            <tr>
              <td><?php echo $_['text_total_order']; ?></td>
              <td><?php echo $total_order; ?></td>
            </tr>
            <tr>
              <td><?php echo $_['text_total_customer']; ?></td>
              <td><?php echo $total_customer; ?></td>
            </tr>
            <tr>
              <td><?php echo $_['text_total_customer_approval']; ?></td>
              <td><?php echo $total_customer_approval; ?></td>
            </tr>
            <tr>
              <td><?php echo $_['text_total_review_approval']; ?></td>
              <td><?php echo $total_review_approval; ?></td>
            </tr>
            <tr>
              <td><?php echo $_['text_total_affiliate']; ?></td>
              <td><?php echo $total_affiliate; ?></td>
            </tr>
            <tr>
              <td><?php echo $_['text_total_affiliate_approval']; ?></td>
      ...
      <div class="statistic">
        <div class="range"><?php echo $_['entry_range']; ?>
          <select id="range" onchange="getSalesChart(this.value)">
            <option value="day"><?php echo $_['text_day']; ?></option>
            <option value="week"><?php echo $_['text_week']; ?></option>
            <option value="month"><?php echo $_['text_month']; ?></option>
            <option value="year"><?php echo $_['text_year']; ?></option>
          </select>
        </div>
        <div class="dashboard-heading"><?php echo $_['text_statistics']; ?></div>
        <div class="dashboard-content">
          <div id="report" style="width: 390px; height: 170px; margin: auto;"></div>
        </div>
      </div>
      <div class="latest">
        <div class="dashboard-heading"><?php echo $_['text_latest_10_orders']; ?></div>
        <div class="dashboard-content">
          <table class="list">
            <thead>
              <tr>
                <td class="right"><?php echo $_['column_order']; ?></td>
...
function getSalesChart(range) {
	$.ajax({
		type: 'get',
		url: '<?php echo UA('common/home/chart'); ?>&range=' + range,
		dataType: 'json',
		async: false,
