...
<body>
<div id="container">
  <div id="menu"><a id="create" class="button" style="background-image: url('view/image/filemanager/folder.png');"><?php echo $_['button_folder']; ?></a><a id="delete" class="button" style="background-image: url('view/image/filemanager/edit-delete.png');"><?php echo $_['button_delete']; ?></a><a id="move" class="button" style="background-image: url('view/image/filemanager/edit-cut.png');"><?php echo $_['button_move']; ?></a><a id="copy" class="button" style="background-image: url('view/image/filemanager/edit-copy.png');"><?php echo $_['button_copy']; ?></a><a id="rename" class="button" style="background-image: url('view/image/filemanager/edit-rename.png');"><?php echo $_['button_rename']; ?></a><a id="upload" class="button" style="background-image: url('view/image/filemanager/upload.png');"><?php echo $_['button_upload']; ?></a><a id="refresh" class="button" style="background-image: url('view/image/filemanager/refresh.png');"><?php echo $_['button_refresh']; ?></a></div>
...
$(document).ready(function() { 
	...
	$('#create').bind('click', function() {
		...
		if (tree.selected) {
			...
			html  = '<div id="dialog">';
			html += '<?php echo $_['entry_folder']; ?> <input type="text" name="name" value="" /> <input type="button" value="<?php echo $_['button_submit']; ?>" />';
			html += '</div>';
			
			$('#column-right').prepend(html);
			
			$('#dialog').dialog({
				title: '<?php echo $_['button_folder']; ?>',
				resizable: false
			});	
			...
			alert('<?php echo $_['error_directory']; ?>');	
		}
	});
	...
	$('#move').bind('click', function() {
		...
		html  = '<div id="dialog">';
		html += '<?php echo $_['entry_move']; ?> <select name="to"></select> <input type="button" value="<?php echo $_['button_submit']; ?>" />';
		html += '</div>';

		$('#column-right').prepend(html);
		
		$('#dialog').dialog({
			title: '<?php echo $_['button_move']; ?>',
			resizable: false
		});
	...
	$('#copy').bind('click', function() {
		...
		html  = '<div id="dialog">';
		html += '<?php echo $_['entry_copy']; ?> <input type="text" name="name" value="" /> <input type="button" value="<?php echo $_['button_submit']; ?>" />';
		html += '</div>';

		$('#column-right').prepend(html);
		
		$('#dialog').dialog({
			title: '<?php echo $_['button_copy']; ?>',
			resizable: false
		});
	...
	$('#rename').bind('click', function() {
		...
		html  = '<div id="dialog">';
		html += '<?php echo $_['entry_rename']; ?> <input type="text" name="name" value="" /> <input type="button" value="<?php echo $_['button_submit']; ?>" />';
		html += '</div>';

		$('#column-right').prepend(html);
		
		$('#dialog').dialog({
			title: '<?php echo $_['button_rename']; ?>',
			resizable: false
		});
