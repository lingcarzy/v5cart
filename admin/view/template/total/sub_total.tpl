...
<div id="content">
  ...
  <div class="box">
    ...
    <div class="content">
      <form action="<?php echo UA('total/sub_total'); ?>" method="post" enctype="multipart/form-data" id="form">
        <table class="form">
          <tr>
            <td><?php echo $_['entry_status']; ?></td>
            <td><select name="sub_total_status">
               <?php echo form_select_option($_['option_statuses'], $sub_total_status, true); ?>
              </select></td>
          </tr>
          <tr>
