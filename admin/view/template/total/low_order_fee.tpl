...
<div id="content">
  ...
  <div class="box">
    ...
    <div class="content">
      <form action="<?php echo UA('total/low_order_fee'); ?>" method="post" enctype="multipart/form-data" id="form">
        <table class="form">
          <tr>
          ...
          <tr>
            ...
            <td><select name="low_order_fee_tax_class_id">
				  ...
				  <?php echo form_select_option($tax_classes, $low_order_fee_tax_class_id, null, 'tax_class_id', 'title'); ?>
                </select></td>
          </tr>
          <tr>
            <td><?php echo $_['entry_status']; ?></td>
            <td><select name="low_order_fee_status">
				<?php echo form_select_option($_['option_statuses'], $low_order_fee_status, true); ?>
              </select></td>
          </tr>
          <tr>
