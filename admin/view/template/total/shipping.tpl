...
<div id="content">
  ...
  <div class="box">
    <div class="heading">
	  ...
	  <a href="<?php echo UA('extension/total'); ?>" class="button"><?php echo $_['button_cancel']; ?></a>
	  </div>
    </div>
    <div class="content">
      <form action="<?php echo UA('total/shipping'); ?>" method="post" enctype="multipart/form-data" id="form">
        <table class="form">
          <tr>
            <td><?php echo $_['entry_estimator']; ?></td>
            <td><select name="shipping_estimator">
			<?php echo form_select_option($_['option_statuses'], $shipping_estimator, true); ?>
              </select></td>
          </tr>
          <tr>
            <td><?php echo $_['entry_status']; ?></td>
            <td><select name="shipping_status">
			<?php echo form_select_option($_['option_statuses'], $shipping_status, true); ?>
              </select></td>
          </tr>
          <tr>
