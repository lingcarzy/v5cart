...
<div id="content">
  ...
  <div class="box">
    ...
    <div class="content">
      <form action="<?php echo UA('total/voucher'); ?>" method="post" enctype="multipart/form-data" id="form">
        <table class="form">
          <tr>
            <td><?php echo $_['entry_status']; ?></td>
            <td><select name="voucher_status">
			<?php echo form_select_option($_['option_statuses'], $voucher_status, true); ?>
              </select></td>
          </tr>
          <tr>
